...
# Mouse stats
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/mouse/Stats_means.Rds"),
        file="data/mouse_means.Rds")
...
# Human stats
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/human/Stats_means.Rds"),
        file="data/human_means.Rds")
...
# Human adipose FACS
#----------------------------------------------------------------------------------------------
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/human_WAT_FACS/data_raw.Rds"),
        file="data/human_WAT_data.Rds")

# Human adipose stats
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/human_WAT_FACS/Stats_means.Rds"),
        file="data/human_WAT_means.Rds")
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/human_WAT_FACS/Stats_M1vsAll.Rds"),
        file="data/human_WAT_M1vsM0.Rds")
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/human_WAT_FACS/Stats_M2vsAll.Rds"),
        file="data/human_WAT_M2vsM0.Rds")
saveRDS(readRDS("../../R_databases/Macrophage_Polarization/human_WAT_FACS/Stats_M1vsM2.Rds"),
        file="data/human_WAT_M1vsM2.Rds")
