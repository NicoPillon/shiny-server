...
datamatrix <- readRDS("../../rawdata/fiber_types/data_out/proteome_matrix.Rds") %>%
  data.frame()
...
file_names <- paste0("datamatrix_proteome_", seq_along(splits), ".parquet")      # Output file names
...
saveRDS(gene_list, "data/list_gene_proteome.Rds")
...
metadata <- readRDS("../../rawdata/fiber_types/data_out/proteome_metadata.Rds")

# Save to app directory
saveRDS(metadata, file = "data/metadata_proteome.Rds")
