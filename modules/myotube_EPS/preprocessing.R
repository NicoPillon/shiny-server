...
datamatrix <- readRDS("../../rawdata/myotube_EPS/data_out/datamatrix.Rds") %>%
  data.frame()
n_genes <- nrow(datamatrix)
chunk_size <- ceiling(n_genes / 2)
...
# METADATA
#--------------------------------------------------------------------------------------------------
metadata <- readRDS("../../rawdata/myotube_EPS/data_out/metadata.Rds")
...
# REFERENCES
#--------------------------------------------------------------------------------------------------
references <- readRDS("../../rawdata/myotube_EPS/data_out/references.Rds")
