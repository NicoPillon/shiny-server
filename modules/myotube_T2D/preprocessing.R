...
datamatrix <- readRDS("../../rawdata/myotube_T2D/data_out/datamatrix.Rds") %>%
  data.frame()
...
metadata <- readRDS("../../rawdata/myotube_T2D/data_out/metadata.Rds")
...
references <- readRDS("../../rawdata/myotube_T2D/data_out/references.Rds")
