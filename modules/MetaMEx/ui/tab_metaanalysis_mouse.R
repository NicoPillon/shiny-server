                                                       ...
                                                       tabPanel("Acute Exercise", value="panelAppAcute",
                                                                fluidRow(style="background-color:white;padding:1% 1% 1% 1%",
                                                                         ...
                                                                         column(2, style="background-color:#eaf1f7;margin-top:60px;padding:0 1% 1% 2%",
                                                                                ...
                                                                                #                    choices=mouse_input[['acute_biopsy_choice']],
                                                                                #                    selected=mouse_input[['acute_biopsy_choice']][1:6]), 
                                                       ...
                                                       tabPanel("Inactivity", value="panelAppInactivity",
                                                                fluidRow(style="background-color:white;padding:1% 1% 1% 1%",
                                                                         ...
                                                                         column(2, style="background-color:#eaf1f7;margin-top:60px;padding:0 1% 1% 2%",
                                                                                ...
                                                                                #                    tags$b("Duration"), 
                                                                                #                    choices=mouse_input[['inactivity_duration_choice']],
                                                                                #                    selected=mouse_input[['inactivity_duration_choice']]),
                                                       ...
                                                       tabPanel("Exercise Training", value="panelAppTraining",
                                                                fluidRow(style="background-color:white;padding:1% 1% 1% 1%",
                                                                         ...
                                                                         column(2, style="background-color:#eaf1f7;margin-top:60px;padding:0 1% 1% 2%",
                                                                                ...
                                                                                #                    choices=mouse_input[['training_duration_choice']],
                                                                                #                    selected=mouse_input[['training_duration_choice']]), 
